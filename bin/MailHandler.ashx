...
public class Handler : IHttpHandler {
	public void ProcessRequest (HttpContext context) {
		...
		string subject = "התקבלה הודעה חדשה מהאתר " + context.Request.Form.Get("name");
		string email = context.Request.Form.Get("email");
		string messageBody = "";
	
		messageBody += "<p>שם לקוח: " + context.Request.Form.Get("name") + "</p>\n";
		messageBody += "<br>\n";
		messageBody += "<p>דואר אלקטרוני: " + context.Request.Form.Get("email") + "</p>\n";
		messageBody += "<br>\n";
		messageBody += "<p>טלפון: " + context.Request.Form.Get("phone") + "</p>\n";
		messageBody += "<br>\n";
		messageBody += "<p>הודעה: " + context.Request.Form.Get("message") + "</p>\n";
